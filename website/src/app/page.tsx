const papers = [
  ...
  },
  {
    ...
    description:
      "Formalizes promoters as function entry points, enhancers as environment variables, silencers as access control. Gene regulatory networks as typed dataflow graphs.",
    color: "#0984e3",
    category: "bio.PL",
  },
  {
    ...
    <div className="min-h-screen" style={{ background: "var(--bg)" }}>
      ...
      <div
        ...
        style={{
          backgroundImage: `repeating-linear-gradient(
            ...
            transparent,
            transparent 40px,
            rgba(0,184,148,0.3) 40px,
            rgba(0,184,148,0.3) 41px
          ),
          repeating-linear-gradient(
            90deg,
            transparent,
            transparent 40px,
            rgba(85,239,196,0.2) 40px,
            rgba(85,239,196,0.2) 41px
          )`,
        }}
      />
      ...
      <section className="pt-32 pb-20 px-6 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            8 Research Papers &middot; Haskell Implementations &middot; bio.PL
          </div>
          ...
          <p
            ...
            style={{ color: "var(--text-dim)" }}
          >
            DNA is not one type&mdash;it contains seven functional data types
            that compose into a complete programming model. We formalize each as
            a typed construct, implement them in Haskell, and synthesize a
            unified orchestration language for biological intent, AI prediction,
            genome editing, and regulatory traceability.
          </p>
      ...
      <section className="py-16 px-6" id="architecture">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <pre style={{ color: "var(--text-dim)" }}>
              ...
              {"]        "}
              <span style={{ color: "#636e72" }}>-- Paper I:   Executable Functions</span>
              {"\n"}
              {"  , "}
              ...
              {"]        "}
              <span style={{ color: "#636e72" }}>-- Paper III: Signals & Middleware</span>
              {"\n"}
              {"  , "}
              ...
              {"]         "}
              <span style={{ color: "#636e72" }}>-- Paper IV:  Memory Layout</span>
              {"\n"}
              {"  , "}
              ...
              {"]            "}
              <span style={{ color: "#636e72" }}>-- Paper V:   Self-Modifying Code</span>
              {"\n"}
              {"  , "}
              ...
              {"]             "}
              <span style={{ color: "#636e72" }}>-- Paper VI:  Runtime State</span>
              {"\n"}
              {"  , "}
              ...
              {"]           "}
              <span style={{ color: "#636e72" }}>-- Paper VII: Orchestration</span>
              {"\n"}
              {"  }"}
            </pre>
          </div>
      ...
      {/* Papers Grid */}
      <section className="py-16 px-6" id="papers">
        <div className="max-w-6xl mx-auto">
          ...
          <p
            ...
            style={{ color: "var(--text-dim)" }}
          >
            Matthew Long &middot; The YonedaAI Collaboration &middot; Chicago, IL
            &middot; March 2026
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {papers.map((paper) => (
              <div
                key={paper.slug}
                className="rounded-xl p-6 transition-all hover:translate-y-[-2px] group"
                style={{
                  background: "var(--surface)",
                  border: "1px solid var(--border)",
                }}
